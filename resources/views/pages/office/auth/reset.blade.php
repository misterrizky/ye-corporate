...
<div class="py-20">
    ...
    <form class="form w-100" novalidate="novalidate" id="form_reset" data-kt-redirect-url="dashboard">
        <input class="form-control form-control-lg form-control-solid" type="hidden" value="{{$token}}" placeholder="token" name="token" />
        <!--begin::Heading-->
        <div class="text-start mb-10">
            <!--begin::Title-->
            <h1 class="text-dark mb-3 fs-3x" data-kt-translate="sign-up-title">Setup New Password</h1>
            <!--end::Title-->
            <!--begin::Text-->
            <div class="text-gray-400 fw-semibold fs-6" data-kt-translate="general-desc">Have you already reset the password ?</div>
            <!--end::Link-->
        </div>
        <!--end::Heading-->
        <!--begin::Input group-->
