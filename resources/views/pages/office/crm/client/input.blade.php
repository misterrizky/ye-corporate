                        ...
                        <div class="scroll-y me-n5 pe-5 h-300px h-xl-auto" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_toolbar, #kt_footer, #kt_contacts_list_header" data-kt-scroll-wrappers="#kt_content, #kt_contacts_list_body" data-kt-scroll-stretch="#kt_contacts_list, #kt_contacts_main" data-kt-scroll-offset="5px">
                            ...
                            <div class="d-flex flex-stack py-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        <a href="javascript:;" onclick="load_url('{{route('office.crm.client.show',$item->id)}}');" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">{{$item->name}}</a>
                    ...
                    <div class="card-body pt-5">
                        <form id="form_input" class="form">
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="load_url('{{route('office.crm.client.index')}}');" class="btn btn-light me-3">Back</button>
                                <button id="tombol_simpan" onclick="handle_upload('#tombol_simpan','#form_input','{{$data->id ? route('office.crm.client.update',$data->id) : route('office.crm.client.store')}}','{{$data->id ? 'PATCH' : 'POST'}}');" class="btn btn-sm btn-{{$data->id ? 'warning' : 'success'}}">
                                    {{$data->id ? 'Update' : 'Create'}}
                                </button>
                                @if($data->id)
                                <button type="button" onclick="handle_confirm('Are you sure want to delete this client ?', 'Yes, i`m sure', 'No, i`m not','DELETE','{{route('office.crm.client.destroy',$data->id)}}');" class="btn btn-sm btn-danger">
                                    Delete
                                </button>
                                @endif
                            </div>
