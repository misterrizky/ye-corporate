                    ...
                    <div id="kt_docs_card_collapsible" class="collapse show">
                        <form id="form_input">
                            ...
                            <div class="card-footer">
                                <button id="tombol_simpan" onclick="handle_upload('#tombol_simpan','#form_input','{{$data->id ? route('office.setting.permission.update',$data->id) : route('office.setting.permission.store')}}','{{$data->id ? 'PATCH' : 'POST'}}');" class="btn btn-sm btn-{{$data->id ? 'warning' : 'success'}}">
                                    {{$data->id ? 'Update' : 'Create'}}
                                </button>
                                @if($data->id)
                                <button type="button" onclick="handle_confirm('Are you sure want to delete this employee ?', 'Yes, i`m sure', 'No, i`m not','DELETE','{{route('office.setting.permission.destroy',$data->id)}}');" class="btn btn-sm btn-danger">
                                    Delete
                                </button>
                                @endif
                            </div>
