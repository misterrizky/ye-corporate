<div class="d-flex flex-stack">
    ...
    <div class="badge badge-lg badge-primary">
        <span id="kt_file_manager_items_counter">{{$collection->count()}} folders</span>
    </div>
</div>
        ...
        <tr>
            <td data-order="account">
                <div class="d-flex align-items-center">
                    ...
                    <a href="javascript:;" onclick="load_url('{{route('office.corporate.document-type.show',$item->id)}}');" class="text-gray-800 text-hover-primary">{{$item->code}} - ({{$item->name}})</a>
                </div>
            </td>
            <td class="text-end" data-kt-filemanager-table="action_dropdown">
                <div class="d-flex justify-content-end">
                    <div class="ms-2">
                        <a href="javascript:;" onclick="edit_type('{{$item->id}}','{{$item->code}}','{{$item->name}}');" class="btn btn-sm btn-hover-scale btn-icon btn-bg-light btn-active-color-warning w-30px h-30px">
...
<script>
    ...
    function edit_type(id,code,name)
    {
