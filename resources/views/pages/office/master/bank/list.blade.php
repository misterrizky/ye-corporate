<table class="table align-middle table-row-dashed fs-6 gy-5" id="table_bank">
    ...
    <tbody class="text-gray-600 fw-semibold">
        ...
        <tr>
            ...
            <td>{{$item->is_activated == 0 ? 'Not Activated' : 'Activated' }}</td>
            <td class="text-end">
                <a href="javascript:;" onclick="load_input('{{route('office.master.bank.edit',$item->id)}}');" class="btn btn-sm btn-hover-scale btn-icon btn-bg-light btn-active-color-warning w-30px h-30px">
