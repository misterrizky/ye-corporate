                    ...
                    <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                        ...
                        <div style="text-align:center; margin:0 15px 34px 15px">
                            ...
                            <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                                ...
                                <p style="margin-bottom:2px; color:#7E8299">Sorry to hear you’re having trouble logging into {{config('app.name')}}. We got a message that you forgot your password.</p>
                                <p style="margin-bottom:2px; color:#7E8299">If this was you, you can get right back into your account or reset your password now.</p>
                            </div>
                            <!--end:Text-->
                        </div>
                        <!--end:Email content-->
                        ...
                        <div style="background: #F9F9F9; border-radius: 12px; padding:35px 30px">
                            ...
                            <div style="display:flex">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <!--begin::Title-->
                                        <a href="{{route('office.auth.reset',$data['token'])}}" target="_blank" style="color:#181C32; font-size: 14px; font-weight: 600;font-family:Arial,Helvetica,sans-serif">Reset Password</a>
                                        <!--end::Title-->
                                        <!--begin::Desc-->
                                        <p style="color:#5E6278; font-size: 13px; font-weight: 500; padding-top:3px; margin:0;font-family:Arial,Helvetica,sans-serif">This password reset link will expire in 60 minutes. If you did not request a password reset, no further action is required.</p>
                                        <!--end::Desc-->
                                    </div>
                                    <!--end::Content-->
                                    <!--begin::Separator-->
