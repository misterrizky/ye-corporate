                        ...
                        <div style="text-align:center; margin:0 15px 34px 15px">
                            ...
                            <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                                ...
                                <p style="margin-bottom:2px; color:#7E8299">
                                    ...
                                    At the same time, as the Yada Ekidanta team, we would like to inform you that you have passed the interview stage. The thing that must be done afterwards is that you are requested to join the WhatsApp link group listed below :
                                </p>
                                <p style="margin-bottom:2px; color:#7E8299">
                                    <a href='https://bit.ly/YEWaGroupIntern' style="background-color:#50CD89; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500;">Join Group</a>
                                </p>
                                <p style="margin-bottom:2px; color:#7E8299">Button not working? Try pasting this URL into your browser:</p>
                                <p style="margin-bottom:2px; color:#7E8299">
                                    <a href='https://bit.ly/YEWaGroupIntern' style="background-color:#50CD89; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500;">https://bit.ly/YEWaGroupIntern</a>
                                </p>
                            </div>
                            <!--end:Text-->
                            <!--begin:Action-->
                        ...
                        <div style="background: #F9F9F9; border-radius: 12px; padding:35px 30px">
                            ...
                            <div style="display:flex">
                                ...
                                <div style="display: flex; justify-content: center; align-items: center; width:40px; height:40px; margin-right:13px">
                                    <img alt="Logo" src="{{asset('keenthemes/media/email/icon-polygon.svg')}}" />
