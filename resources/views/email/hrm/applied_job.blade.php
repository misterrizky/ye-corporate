                    ...
                    <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                        ...
                        <div style="text-align:center; margin:0 15px 34px 15px">
                            ...
                            <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                                ...
                                <p style="margin-bottom:2px; color:#7E8299">Candidate {{$employee->name}} just joined</p>
                            </div>
                            <!--end:Text-->
                        </div>
                        <!--end:Email content-->
                        ...
                        <div style="background: #F9F9F9; border-radius: 12px; padding:35px 30px">
                            ...
                            <div style="display:flex">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <!--begin::Title-->
                                        <a href="#" style="color:#181C32; font-size: 14px; font-weight: 600;font-family:Arial,Helvetica,sans-serif">Review {{$employee->name}}</a>
                                        <!--end::Title-->
                                        <!--begin::Desc-->
                            ...
                            <div style="display:flex">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <!--begin::Title-->
                                        <a href="#" style="color:#181C32; font-size: 14px; font-weight: 600;font-family:Arial,Helvetica,sans-serif">Make decision</a>
                                        <!--end::Title-->
                                        <!--begin::Desc-->
