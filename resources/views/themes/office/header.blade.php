    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="javascript:;" class="d-lg-none">
                <img alt="Logo" src="{{asset('img/icon.png')}}" class="h-30px" />
            </a>
        </div>
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}">
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                    ...
                    <div class="menu-item">
                        <a class="btn btn-sm btn-light-success" href="javascript:;" onclick="load_url('{{route('office.todo.index')}}');">
                    ...
                    <div class="menu-item">
                        <a class="btn btn-sm btn-light-warning" href="javascript:;" onclick="load_url('{{route('office.hrm.day-off.index')}}');">
                            ...
                            <span class="menu-title">Request Days Off</span>
                        </a>
                    </div>
                    @endif
                </div>
            ...
            <div class="app-navbar flex-shrink-0">
                            ...
                            <div data-kt-search-element="wrapper">
                                ...
                                <div data-kt-search-element="results" class="d-none">
                                    <div class="scroll-y mh-200px mh-lg-350px">
                                        ...
                                        <a href="javascript:;" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{asset('keenthemes/media/avatars/300-6.jpg')}}" alt="" />
                                            </div>
                                        ...
                                        <a href="javascript:;" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{asset('keenthemes/media/avatars/300-2.jpg')}}" alt="" />
                                            </div>
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                        ...
                                        <a href="javascript:;" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{asset('keenthemes/media/avatars/300-9.jpg')}}" alt="" />
                                            </div>
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                        ...
                                        <a href="javascript:;" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{asset('keenthemes/media/avatars/300-14.jpg')}}" alt="" />
                                            </div>
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                        ...
                                        <a href="javascript:;" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{asset('keenthemes/media/avatars/300-11.jpg')}}" alt="" />
                                            </div>
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                        ...
                                        <a href="javascript:;" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px" src="{{asset('keenthemes/media/svg/brand-logos/volicity-9.svg')}}" alt="" />
                                                </span>
                                            </div>
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                        ...
                                        <a href="javascript:;" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px" src="{{asset('keenthemes/media/svg/brand-logos/tvit.svg')}}" alt="" />
                                                </span>
                                            </div>
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                        ...
                                        <a href="javascript:;" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px" src="{{asset('keenthemes/media/svg/misc/infography.svg')}}" alt="" />
                                                </span>
                                            </div>
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                        ...
                                        <a href="javascript:;" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px" src="{{asset('keenthemes/media/svg/brand-logos/leaf.svg')}}" alt="" />
                                                </span>
                                            </div>
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                        ...
                                        <a href="javascript:;" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px" src="{{asset('keenthemes/media/svg/brand-logos/tower.svg')}}" alt="" />
                                                </span>
                                            </div>
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                ...
                                <div class="mb-5" data-kt-search-element="main">
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-325px">
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="javascript:;" class="fs-6 text-gray-800 text-hover-primary fw-semibold">BoomApp by Keenthemes</a>
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="javascript:;" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"Kept API Project Meeting</a>
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="javascript:;" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"KPI Monitoring App Launch</a>
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="javascript:;" class="fs-6 text-gray-800 text-hover-primary fw-semibold">Project Reference FAQ</a>
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="javascript:;" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"FitPro App Development</a>
                                                <span class="fs-7 text-muted fw-semibold">#84250</span>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="javascript:;" class="fs-6 text-gray-800 text-hover-primary fw-semibold">Shopix Mobile App</a>
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="javascript:;" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"Landing UI Design" Launch</a>
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" id="kt_activities_toggle" onclick="load_memo('{{route('office.employee-memo.index')}}');">
                        <span class="svg-icon svg-icon-1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.3" d="M19 22H5C4.4 22 4 21.6 4 21V3C4 2.4 4.4 2 5 2H14L20 8V21C20 21.6 19.6 22 19 22ZM12.5 18C12.5 17.4 12.6 17.5 12 17.5H8.5C7.9 17.5 8 17.4 8 18C8 18.6 7.9 18.5 8.5 18.5L12 18C12.6 18 12.5 18.6 12.5 18ZM16.5 13C16.5 12.4 16.6 12.5 16 12.5H8.5C7.9 12.5 8 12.4 8 13C8 13.6 7.9 13.5 8.5 13.5H15.5C16.1 13.5 16.5 13.6 16.5 13ZM12.5 8C12.5 7.4 12.6 7.5 12 7.5H8C7.4 7.5 7.5 7.4 7.5 8C7.5 8.6 7.4 8.5 8 8.5H12C12.6 8.5 12.5 8.6 12.5 8Z" fill="currentColor"/>
                                <rect x="7" y="17" width="6" height="2" rx="1" fill="currentColor"/>
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    <div id="notification" class="btn btn-icon btn-custom pulse pulse-primary btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px position-relative" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <span class="svg-icon svg-icon-1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span id="notification_pulse" class="pulse-ring"></span>
                        <span id="notification_blink" class="bullet bullet-dot bg-primary h-6px w-6px position-absolute translate-middle top-0 start-50 animation-blink"></span>
                    </div>
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{asset('keenthemes/media/misc/pattern-1.jpg')}}')">
                            <h3 class="text-white fw-semibold px-9 mt-10 mb-6">
                                Notifications
                                <span id="total_notif" class="fs-8 opacity-75 ps-3"></span></h3>
                            </h3>
                            <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                                <li class="nav-item">
                                    <a class="nav-link text-white opacity-75 opacity-state-100 pb-4 active" data-bs-toggle="tab" href="#notif_alert">Alerts</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-white opacity-75 opacity-state-100 pb-4" data-bs-toggle="tab" href="#notif_update">Updates</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-white opacity-75 opacity-state-100 pb-4" data-bs-toggle="tab" href="#notif_log">Logs</a>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="notif_alert" role="tabpanel">
                            ...
                            <div class="tab-pane fade" id="notif_update" role="tabpanel">
                                <div class="d-flex flex-column px-9">
                                    <div class="pt-10 pb-0">
                                        <h3 class="text-dark text-center fw-bold">Get Pro Access</h3>
                                        <div class="text-center text-gray-600 fw-semibold pt-1">Outlines keep you honest. They stoping you from amazing poorly about drive</div>
                                        <div class="text-center mt-5 mb-9">
                                            <a href="javascript:;" class="btn btn-sm btn-primary px-6" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Upgrade</a>
                                        </div>
                                    </div>
                                    <div class="text-center px-4">
                                        <img class="mw-100 mh-200px" alt="image" src="{{asset('keenthemes/media/illustrations/sketchy-1/1.png')}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="notif_log" role="tabpanel">
                                <div class="scroll-y mh-325px my-5 px-8">
                                    <div id="notification_log_item"></div>
                                </div>
                                <div class="py-3 text-center border-top d-none">
                                    <a href="../../demo1/dist/pages/user-profile/activity.html" class="btn btn-color-gray-600 btn-active-color-primary">View All
                                        <span class="svg-icon svg-icon-5">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    <a href="javascript:;" class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        {!!Auth::guard('employees')->user()->image!!}
                    </div>
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="javascript:;" class="fw-semibold text-muted text-hover-primary fs-7">{{Str::limit(Auth::guard('employees')->user()->email, 25, $end='...')}}</a>
                                </div>
                            </div>
                        </div>
                        <div class="separator my-2"></div>
                        <div class="menu-item px-5">
                            <a href="javascript:;" onclick="load_url('{{route('office.profile.index')}}');" class="menu-link px-5">My Profile</a>
                        </div>
                        @if(Auth::guard('employees')->user()->department_id != 0 && Auth::guard('employees')->user()->position_id != 0)
                        <div class="menu-item px-5">
                            <a href="javascript:;" onclick="load_url('{{route('office.profile.project')}}');" class="menu-link px-5">
                        ...
                        <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start">
                            ...
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                <div class="menu-item px-3">
                                    <a href="javascript:;" onclick="load_url('{{route('office.profile.referral')}}');" class="menu-link px-5">Referrals</a>
                                </div>
                                <div class="menu-item px-3">
                                    <a href="javascript:;" onclick="load_url('{{route('office.profile.billing')}}');" class="menu-link px-5">Billing</a>
                                </div>
                                <div class="menu-item px-3">
                                    <a href="javascript:;" onclick="load_url('{{route('office.profile.statement')}}');" class="menu-link px-5">Payments</a>
                                </div>
                                <div class="menu-item px-3">
                                    <a href="javascript:;" onclick="load_url('{{route('office.profile.statement')}}');" class="menu-link d-flex flex-stack px-5">Statements
                        ...
                        <div class="menu-item px-5">
                            <a href="javascript:;" onclick="load_url('{{route('office.profile.statement')}}');" class="menu-link px-5">My Statements</a>
                        </div>
                        <div class="separator my-2"></div>
                        @endif
                        <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start">
                            <a href="javascript:;" class="menu-link px-5">
                                <span class="menu-title position-relative">
                                    Language
                                    <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0" data-kt-element="current-lang-name">English
                                        <img class="w-15px h-15px rounded-1 ms-2" data-kt-element="current-lang-flag" src="{{asset('keenthemes/media/flags/united-states.svg')}}" alt="" />
                                    </span>
                                </span>
                            </a>
                            <div class="menu-sub menu-sub-dropdown w-175px py-4" id="kt_auth_lang_menu">
                                <div class="menu-item px-3">
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="javascript:;" onclick="load_url('{{route('office.profile.setting')}}');" class="menu-link px-5">Account Settings</a>
                        </div>
                        <div class="menu-item px-5">
