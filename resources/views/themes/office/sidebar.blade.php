<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        <!--begin::Logo image-->
        <a href="javascript:;">
            <img alt="Logo" src="{{asset('img/icon.png')}}" class="h-25px app-sidebar-logo-default" />
            <img alt="Logo" src="{{asset('img/icon.png')}}" class="h-20px app-sidebar-logo-minimize" />
        </a>
        <!--end::Logo image-->
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{request()->is('dashboard') || request()->is('dashboard-ecommerce') || request()->is('dashboard-project') || request()->is('dashboard-marketing') || request()->is('dashboard-analytic') || request()->is('dashboard-finance') ? 'here show' : ''}}">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link sidebar-link {{request()->is('dashboard') ? 'active' : ''}}" href="javascript:;" onclick="load_url('{{route('office.dashboard')}}');">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link sidebar-link {{request()->is('dashboard-ecommerce') ? 'active' : ''}}" href="javascript:;" onclick="load_url('{{route('office.dashboard.ecommerce')}}');">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link sidebar-link {{request()->is('dashboard-project') ? 'active' : ''}}" href="javascript:;" onclick="load_url('{{route('office.dashboard.project')}}');">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link sidebar-link {{request()->is('dashboard-marketing') ? 'active' : ''}}" href="javascript:;" onclick="load_url('{{route('office.dashboard.marketing')}}');">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-inner flex-column collapse" id="kt_app_sidebar_menu_dashboards_collapse">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link sidebar-link {{request()->is('dashboard-analytic') ? 'active' : ''}}" href="javascript:;" href="javascript:;" onclick="load_url('{{route('office.dashboard.analytic')}}');">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link sidebar-link {{request()->is('dashboard-finance') ? 'active' : ''}}" href="javascript:;" href="javascript:;" onclick="load_url('{{route('office.dashboard.finance')}}');">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link sidebar-link {{request()->is('event') ? 'active' : ''}}" href="javascript:;" onclick="load_url('{{route('office.master.event.index')}}');">
                        <span class="menu-icon">
                ...
                <!--begin:Menu item-->
                <div class="menu-item">
                    <a class="menu-link sidebar-link {{request()->is('document-type') || request()->is('document-type/*') ? 'active' : ''}}" href="javascript:;" onclick="load_url('{{route('office.corporate.document-type.index')}}');">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <!--end:Menu item-->
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{request()->is('country') || request()->is('country/*') || request()->is('province') || request()->is('province/*') || request()->is('regency') || request()->is('regency/*') || request()->is('district') || request()->is('district/*') || request()->is('village') ? 'here show' : ''}}">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                        <span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link sidebar-link {{request()->is('country') || request()->is('country/*') || request()->is('province') || request()->is('province/*') || request()->is('regency') || request()->is('regency/*') || request()->is('district') || request()->is('district/*') || request()->is('village') ? 'active' : ''}}" href="javascript:;" onclick="load_url('{{route('office.regional.country.index')}}');">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link sidebar-link {{request()->is('bank') ? 'active' : ''}}" href="javascript:;" onclick="load_url('{{route('office.master.bank.index')}}');">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link sidebar-link {{request()->is('isic-type') || request()->is('isic-type/*') ? 'active' : ''}}" href="javascript:;" onclick="load_url('{{route('office.master.isic-type.index')}}');">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">ISIC</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                ...
                <!--end:Menu item-->
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{request()->is('department') || request()->is('department/*') || request()->is('employee') || request()->is('employee/*') ? 'here show' : ''}}">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/communication/com005.svg-->
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link sidebar-link {{request()->is('department') || request()->is('department/*') ? 'active' : ''}}" href="javascript:;" onclick="load_url('{{route('office.hrm.department.index')}}');">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link sidebar-link {{request()->is('employee') || request()->is('employee/*') ? 'active' : ''}}" href="javascript:;" onclick="load_url('{{route('office.hrm.employee.index')}}');">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link sidebar-link {{request()->is('vacancy-job') || request()->is('vacancy-job/*') ? 'active' : ''}}" href="javascript:;" onclick="load_url('{{route('office.hrm.vacancy.index')}}');">
                                ...
                                <span class="menu-title">Vacancy Job</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                ...
                <!--end:Menu item-->
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{request()->is('lead') || request()->is('lead/*') || request()->is('client') || request()->is('client/*') ? 'here show' : ''}}">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/communication/com005.svg-->
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link sidebar-link {{request()->is('legal-policy') ? 'active' : ''}}" href="javascript:;" onclick="load_url('{{route('office.corporate.legal-policy.index')}}');">
                                ...
                                <span class="menu-title">Legal Policy</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link sidebar-link {{request()->is('newsletter') ? 'active' : ''}}" href="javascript:;" onclick="load_url('{{route('office.crm.newsletter.index')}}');">
                        <span class="menu-icon">
