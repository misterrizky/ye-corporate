...
class UpdateDocumentNotification extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'pesan' => "Hi ".$this->employee->name.", File ".$this->doc->code." just updated by ".$this->employee->name." at ".date('d F Y, g:i a')."."
        ];
    }
}
