...
class CreateDocumentTypeNotification extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'pesan' => "Hi ".$this->employee->name.", Folder ".$this->type->name." just created by ".$this->employee->name." at ".date('d F Y, g:i a')."."
        ];
    }
}
